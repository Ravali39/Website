  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><span> Communicator </span></a>
      </div>
      ...
      <div class="row">
        ...
        <div class="feature-info">
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                ...
                <p>New technologies are constantly being developed and implemented in the IT (information technology) industry.</p>
              </div>
          ...
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                ...
                <p>Based on our research, we compiled this feature comparison chart to see what the competitive landscape looks like at a glance. As you can see, these popular messaging apps mostly have feature parity.</p>
              </div>
              <div class="fea-img pull-left">
          ...
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                <h4>Winning Design</h4>
                <p>Online chats have become an eminent part of both our daily life and business environment. Instant messaging is faster and more convenient than email and less stressful than a phone call, so there is no wonder why we use chat apps so often.</p>
              </div>
              <div class="fea-img pull-left">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-info">
            ...
            <p class="det-p">To build a world that is peaceful and wealthy, it is essential to provide quality education to everyone.</p>
          </div>
        </div> 
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="pm-staff-profile-container">
          ...
          <img src="img\Hyunsook_Do.jpg" alt="Cinque Terre" class="img-circle" >
              </div>
            </div>
            <p></p>
            <div class="pm-staff-profile-details text-center">
             ...
             <p>  </p>
              ...
              <p class="pm-staff-profile-name">Hynsook_Do</p>
              
             
                 <p class="pm-staff-profile-bio">Dr. Do's research interests lie in software engineering, particularly software testing, maintenance, and empirical methodologies. She has been working on problems on evolution-aware testing techniques for object-oriented systems, including test selection, prioritization, test suite design, unit/integration testing, and model-based requirements verification. She received a National Science Foundation CAREER Award in 2012 for her research on software maintenance and testing. </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            <div class="pm-staff-profile-image-wrapper text-center">
            <div class="pm-staff-profile-image">
            <img src="img\Asif_Baba.jpg" alt="Cinque Terre" class="img-circle" />
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            <div class="pm-staff-profile-image-wrapper text-center">
              <div class="pm-staff-profile-image">
                <img src="img\Russel_Pears.jpg" alt="" class="img-thumbnail img-circle" />
              </div>
            </div>
            <p></p>
               <p></p>
            ...
            <div class="pm-staff-profile-details text-center">
              ...
              <p class="pm-staff-profile-name">Russel_pears</p>
              <p class="pm-staff-profile-bio">Interested in mining streams of data that are continuously subject to change over time. Given the explosion in the growth of data coupled with major advances in network bandwidth, a new and growing list of applications produce high speed stream of data that need to be mined in real-time. I have established a strong international research profile in this area having published a total of 19 publications in major journals and conferences in the last 4 years, including 3 in the year to date at A*-ranked venues.
 </p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          ...
          <p class="white">Thanks to our loyal Suggestions and to their advices<br> It means a lot to us.</p>
  ...
  <section id="courses" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          <h2>Courses</h2>
          <p>Thousands of courses are at your disposal<br>,So what are you waiting for!</p>
          <hr class="bottom-line">
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            ...
            <figcaption>
              ...
              <p>The different phases of the software development lifecycle (SDLC) that involve creating, deploying, and sustaining software products are discussed in this course. On top of that, students will acquire knowledge of the fundamentals of software development.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            ...
            <figcaption>
              ...
              <p>This course provides  introduction of computer networks , with a focus on the architecture and protocols of the Internet. The client-server concept, web and email protocols, layered network architectures, addressing, naming, forwarding, and routing are among the topics covered.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            ...
            <figcaption>
              <h3>Fundamentals of Databse </h3>
              <p>This course provides introduction of Data Base concepts including Relational databases, tables and data types, data selection and manipulation, views, stored procedures, functions, normalization, constraints, indexes, security, and backup and restore are all covered .</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            ...
            <figcaption>
              ...
              <p>This course provides intelligence exhibited by machines,as oppossed to intelligence of human and others.people and other animals,AI is the intelligence displayed by robots.Speech recognition,computer vision,interlanguage translation,and various mappings few activities.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            ...
            <figcaption>
              ...
              <p>Cybersecurity is security. This includes any data-related technology, such as computers, data networks, and all elements of networks, such as switches and routers. It is essential for safeguarding all information systems devices and infrastructure from illegal access.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            ...
            <figcaption>
              ...
              <p>This course provides 2D/3D signals ,sensor modality and digital encoding , Filter and enhance images in spatial and frequency domain,Image restoration,edge segmentation ,and also design algorithm for object recognignition.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
  ...
  <footer id="footer" class="footer">
    <div class="container text-center">
      ...
      <div class="credits">
        ...
        -->
        Designed by <a> Team Avengers SE</a>
      </div>
    </div>
  </footer>
  <!--/ Footer-->
